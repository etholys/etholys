            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input value={editForm?.region ?? ''} onChange={e => setEditForm({ ...editForm, region: e.target.value })} placeholder="Latinoamérica..." className="w-full px-3 py-2 rounded-lg border text-sm" />
                </div>
                <div>
