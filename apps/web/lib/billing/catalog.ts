...
const ADDON_SKUS: BillingSku[] = [
  ...
  {
    code: 'addon.atlas.smart_import',
    kind: 'addon',
    name: L('ATLAS Smart Import (IA)', 'ATLAS Smart Import (IA)', 'ATLAS Smart Import (AI)'),
    blurb: L(
      'PDF, extractos e imagens → transações pré-preenchidas. A planilha ATLAS continua incluída.',
      'PDF, extractos e imágenes → transacciones prellenadas. La planilla ATLAS sigue incluida.',
      'PDFs, statements, and images → pre-filled transactions. The ATLAS spreadsheet stays included.',
    ),
    systems: [],
