...
const BASE_PATHS: Record<string, (net: string | null) => string> = {
  ...
  at: (n) => withNetwork('/hub/nexus/at', n),
...
const STEPS: Record<VentureStageId, NexusQuickStep[]> = {
  ...
  FOCUS: [
    ...
    {
      id: 'foc-3',
      titlePt: 'Rever fase e metas da empresa',
      titleEs: 'Revisar fase y metas de la empresa',
      titleEn: 'Review company phase & goals',
      hintPt: 'Alinha a fase da jornada com o que o negócio precisa agora (melhoria interna).',
      hintEs: 'Alineá la fase del recorrido con lo que el negocio necesita ahora (mejora interna).',
      hintEn: 'Align journey phase with what the business needs now (internal improvement).',
      path: 'journey',
      emphasis: 'default',
    },
  ],
