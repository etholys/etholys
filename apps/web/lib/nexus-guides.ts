...
const STEPS: Record<VentureStageId, NexusQuickStep[]> = {
  ...
  FOCUS: [
    ...
    {
      id: 'foc-3',
      titlePt: 'Abrir caso de assistência técnica',
      titleEs: 'Abrir caso de asistencia técnica',
      titleEn: 'Open a tech-assistance case',
      hintPt: 'Serviço → projeto → empresa: atendimento externo separado por cliente.',
      hintEs: 'Servicio → proyecto → empresa: atención externa por cliente.',
      hintEn: 'Service → project → company: external support per client.',
      path: 'at',
      emphasis: 'default',
    },
  ],
